<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="movies.aspx.cs" Inherits="moviebooking1.movies" %>--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="movies.aspx.cs" Inherits="moviebooking1.movies" %>
...
<body>
	...
	<header id="site-header" class="w3l-header fixed-top">
		...
		<nav class="navbar navbar-expand-lg navbar-light fill px-lg-0 py-0 px-3">
			<div class="container">
				<h1><a class="navbar-brand" href="Home.aspx"><span class="fa fa-play icon-log"
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
							...
							<div class="popup">
								...
								<div class="browse-items">
									...
									<ul class="search-items">
										<li><a href="movies.aspx">Action</a></li>
										<li><a href="movies.aspx">Drama</a></li>
										<li><a href="movies.aspx">Family</a></li>
										<li><a href="movies.aspx">Thriller</a></li>
										<li><a href="movies.aspx">Commedy</a></li>
										<li><a href="movies.aspx">Romantic</a></li>
										<li><a href="movies.aspx">Tv-Series</a></li>
										<li><a href="movies.aspx">Horror</a></li>
										<li><a href="movies.aspx">Action</a></li>
										<li><a href="movies.aspx">Drama</a></li>
										<li><a href="movies.aspx">Family</a></li>
										<li><a href="movies.aspx">Thriller</a></li>
					...
					<div class="Login_SignUp" id="login"
						...
						<!-- <li class="nav-item"> -->
						<a class="nav-link" href="sign_in.aspx"><i class="fa fa-user-circle-o"></i></a>
						<!-- </li> -->
					</div>
	...
	<div class="w3l-breadcrumbs">
		<nav id="breadcrumbs" class="breadcrumbs">
			<div class="container page-wrapper">
				<a href="Home.aspx">Home</a> » <span class="breadcrumb_last" aria-current="page">movies</span>
			</div>
		</nav>
	</div>
	<!--/movies -->
				...
				<div class="headerhny-title">
					<div class="w3l-title-grids">
						...
						<div class="headerhny-right text-lg-right">
							<h4><a class="show-title" href="movies.aspx">Show all</a></h4>
						</div>
					</div>
				</div>
									...
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="bookbtn">
											<button type="button" class="btn btn-success"
												onclick="location.href='ticket_booking.aspx';">Book</button>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="row">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.aspx">Long Shot</a>
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.aspx"><img src="assets/images/m5.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.aspx">Jumanji</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.aspx"><img src="assets/images/m4.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.aspx">Little Women</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.aspx"><img src="assets/images/m1.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.aspx">Rocketman</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.aspx"><img src="assets/images/m2.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.aspx">Doctor Sleep</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.aspx"><img src="assets/images/m3.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.aspx">Knives Out</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.aspx"><img src="assets/images/n1.jpg" class="img-fluid"
														alt="author image">
													<span class="fa fa-play video-icon" aria-hidden="true"></span>
												</a>
											</div>
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.aspx">No Time to Die</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.aspx"><img src="assets/images/n2.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.aspx">Mulan</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.aspx"><img src="assets/images/n3.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.aspx">Free Guy</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
							...
							<div class="albums-content">
								<div class="row">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.aspx"><img src="assets/images/m7.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.aspx">Frozen 2</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.aspx"><img src="assets/images/m8.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.aspx">Toy Story 4</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.aspx"><img src="assets/images/m9.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.aspx">Joker</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
							...
							<div class="albums-content">
								<div class="row">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.aspx"><img src="assets/images/m10.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.aspx">Alita</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
													</span>
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.aspx"><img src="assets/images/m11.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.aspx">The Lego</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
													</span>
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.aspx"><img src="assets/images/m12.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.aspx">The Hustle</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
						...
						<div class="right-side">
							<div class="row footer-about">
								<div class="col-md-3 col-6 footer-img mb-lg-0 mb-4">
									<a href="movies.aspx"><img class="img-fluid" src="assets/images/banner1.jpg"
											alt=""></a>
								</div>
								<div class="col-md-3 col-6 footer-img mb-lg-0 mb-4">
									<a href="movies.aspx"><img class="img-fluid" src="assets/images/banner2.jpg"
											alt=""></a>
								</div>
								<div class="col-md-3 col-6 footer-img mb-lg-0 mb-4">
									<a href="movies.aspx"><img class="img-fluid" src="assets/images/banner3.jpg"
											alt=""></a>
								</div>
								<div class="col-md-3 col-6 footer-img mb-lg-0 mb-4">
									<a href="movies.aspx"><img class="img-fluid" src="assets/images/banner4.jpg"
											alt=""></a>
								</div>
							</div>
							<div class="row footer-links">
								...
								<div class="col-md-3 col-sm-6 sub-two-right mt-5">
									<h6>Locations</h6>
									<ul>
										<li><a href="movies.aspx">Asia</a></li>
										<li><a href="movies.aspx">France</a></li>
										<li><a href="movies.aspx">Taiwan</a></li>
										<li><a href="movies.aspx">United States</a></li>
										<li><a href="movies.aspx">Korea</a></li>
										<li><a href="movies.aspx">United Kingdom</a></li>
									</ul>
								</div>
								<div class="col-md-3 col-sm-6 sub-two-right mt-5">
									<h6>Newsletter</h6>
