<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="moviebooking1._Default" %>
...
<body>
				...
				<div class="headerhny-title">
					<div class="w3l-title-grids">
						<div class="headerhny-left">
							<h3 class="hny-title">Popular Movies</h3>
							<div class="headerhny-right text-lg-right">
							<h4><a class="show-title" href="Movie.aspx">Show all</a></h4>
		...
		<ItemTemplate>
			<div class="item vhny-grid">
						<div class="box16">
							<a href="Movie.aspx">
								<figure>
									<img class="img-fluid" src='../Admin/img/<%#Eval("Image") %>' alt="">
								</figure>
								<div class="box-content">
									<h3 class="title"><%#Eval("Movie_Name") %></h3>
									<h4> <span class="post"><span class="fa fa-clock-o"> </span> <%#Eval("Show_Time") %>
    ...
    <!--//grids-sec1-->
    <!--grids-sec2-->
    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:MovieDB1ConnectionString2 %>' ProviderName='<%$ ConnectionStrings:MovieDB1ConnectionString2.ProviderName %>' SelectCommand="SELECT TOP 4 * FROM  [Movie]"></asp:SqlDataSource>
    <section class="w3l-grids">
		<div class="grids-main py-5">
			<div class="container py-lg-3">
				<div class="headerhny-title">
				...
				<div class="owl-three owl-carousel owl-theme">
					<div class="item vhny-grid">
						...
						<h3> <a class="title-gd" href="Movie.aspx">No Time to Die</a></h3>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
						<div class="button-center text-center mt-4">
							<a href="Movie.aspx" class="btn watch-button">Watch now</a>
						</div>
					...
					<div class="item vhny-grid">
						...
						<h3> <a class="title-gd" href="Movie.aspx">Mulan</a></h3>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
						<div class="button-center text-center mt-4">
							<a href="Movie.aspx" class="btn watch-button">Watch now</a>
						</div>
					...
					<div class="item vhny-grid">
						...
						<h3> <a class="title-gd" href="Movie.aspx">Free Guy</a></h3>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
						<div class="button-center text-center mt-4">
							<a href="Movie.aspx" class="btn watch-button">Watch now</a>
						</div>
					...
					<div class="item vhny-grid">
						...
						<h3> <a class="title-gd" href="Movie.aspx">My Spy</a></h3>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
						<div class="button-center text-center mt-4">
							<a href="Movie.aspx" class="btn watch-button">Watch now</a>
						</div>
					...
					<div class="item vhny-grid">
						...
						<h3> <a class="title-gd" href="Movie.aspx">Scoob</a></h3>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
						<div class="button-center text-center mt-4">
							<a href="Movie.aspx" class="btn watch-button">Watch now</a>
						</div>
					...
					<div class="item vhny-grid">
						...
						<h3> <a class="title-gd" href="Movie.aspx">Downhill</a></h3>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
						<div class="button-center text-center mt-4">
							<a href="Movie.aspx" class="btn watch-button">Watch now</a>
						</div>
						...
						<div class="slider-info mid-view bg bg2">
							<div class="container">
								<div class="mid-info">
									...
									<a class="watch" href="Movie.aspx"><span class="fa fa-play"
											aria-hidden="true"></span>
										Watch Trailer</a>
								</div>
							</div>
						...
						<div class="right-side">
							<div class="row footer-about">
								<div class="col-md-3 col-6 footer-img mb-lg-0 mb-4">
									<a href="Movie.aspx"><img class="img-fluid" src="assets/images/banner1.jpg"
											alt=""></a>
								</div>
								<div class="col-md-3 col-6 footer-img mb-lg-0 mb-4">
									<a href="Movie.aspx"><img class="img-fluid" src="assets/images/banner2.jpg"
											alt=""></a>
								</div>
								<div class="col-md-3 col-6 footer-img mb-lg-0 mb-4">
									<a href="Movie.aspx"><img class="img-fluid" src="assets/images/banner3.jpg"
											alt=""></a>
								</div>
								<div class="col-md-3 col-6 footer-img mb-lg-0 mb-4">
									<a href="Movie.aspx"><img class="img-fluid" src="assets/images/banner4.jpg"
											alt=""></a>
								</div>
							</div>
							<div class="row footer-links">
								...
								<div class="col-md-3 col-sm-6 sub-two-right mt-5">
									<h6>Locations</h6>
									<ul>
										<li><a href="Movie.aspx">Asia</a></li>
										<li><a href="Movie.aspx">France</a></li>
										<li><a href="Movie.aspx">Taiwan</a></li>
										<li><a href="Movie.aspx">United States</a></li>
										<li><a href="Movie.aspx">Korea</a></li>
										<li><a href="Movie.aspx">United Kingdom</a></li>
									</ul>
								</div>
								<div class="col-md-3 col-sm-6 sub-two-right mt-5">
									<h6>Newsletter</h6>
