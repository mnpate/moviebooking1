<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Movie.aspx.cs" Inherits="moviebooking1.Movie" %>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active">
							<a class="nav-link" href="Movie.aspx">Movies</a>
						</li>
						<li class="nav-item">
	...
	<div class="w3l-breadcrumbs">
		<nav id="breadcrumbs" class="breadcrumbs">
			<div class="container page-wrapper">
				<a href="Home.aspx">Home</a> » <span class="breadcrumb_last" aria-current="page">Movie</span>
			</div>
		</nav>
	</div>
	<!--/movies -->
			...
			<div class="container py-lg-4">
				...
				<div class="w3l-populohny-grids">
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="assets/images/commando3.jpg" alt="">
							</figure>
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="assets/images/commando3.jpg" class="img-fluid modalimg" alt="" />
											<p>
										...
										<div class="bookbtn">
											<button type="button" class="btn btn-success"
												onclick="location.href='Ticket_Book.aspx';">Book</button>
											<%--<asp:Button ID="Button1" class="btn btn-success" runat="server" Text="Book" onclick="loction.href='Ticket_Book.aspx';"/>--%>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							...
							<a href=".Knivesout" data-toggle="modal">
								<div class="box-content">
									<a href="popup.aspx" class="title">Knives Out</a>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="assets/images/bharat1.jpg" alt="">
							</figure>
				...
				<div class="w3l-populohny-grids">
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="assets/images/ks1.jpg" alt="">
							</figure>
				...
				<div class="w3l-populohny-grids">
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="assets/images/gk.jpg" alt="">
							</figure>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="assets/images/gujjubhai.jpg" alt="">
							</figure>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="assets/images/Thaijase.jpg" alt="">
							</figure>
