<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="moviebooking1.About" %>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<div class="Login_SignUp" id="login"
						...
						<!-- <li class="nav-item"> -->
						<a class="nav-link" href="Login.aspx"><i class="fa fa-user-circle-o"></i></a>
						<!-- </li> -->
					</div>
				</div>
	...
	<div class="w3l-breadcrumbs">
		<nav id="breadcrumbs" class="breadcrumbs">
			<div class="container page-wrapper">
				<a href="Home.aspx">Home</a> » <span class="breadcrumb_last" aria-current="page">About</span>
			</div>
		</nav>
	</div>
	<!-- /about-->
