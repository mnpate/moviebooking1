<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ticket_booking.aspx.cs" Inherits="moviebooking1.ticket_booking" %>
...
<body>
  <header id="site-header" class="w3l-header fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fill px-lg-0 py-0 px-3">
      <div class="container">
        <h1><a class="navbar-brand" href="Home.aspx"><span class="fa fa-play icon-log" aria-hidden="true"></span>
            MyShowz </a></h1>
